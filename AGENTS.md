...
- `aspens doc graph [path]` — Rebuild import graph cache (`.agents/skills/architecture/references/code-map.md`)
...
|--------|-------|-------------|
| src | 47 | `src/commands/doc-init.js`, `src/lib/runner.js`, `src/lib/target.js` |
